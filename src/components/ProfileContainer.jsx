...
const ProfileContainer = () => {
  ...
  return (
    <div className="profile-container">
      <div 
        className={`profile-image-wrapper ${animation.isExpanded || animation.isExpanding ? 'hidden' : ''}`}
        style={{
         
          transform: `scale(${isDesktop ? 1 : 0.8})`
        }}
      >
        <ProfileImage 
      ...
      <ExpandedProfile 
        isVisible={animation.isExpanded || animation.isExpanding}
        isCollapsing={animation.isCollapsing}
